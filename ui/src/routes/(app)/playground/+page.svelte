<script lang="ts">
  ...
  const scrollToBottom = () => {
    const element =
      mode === "chat" ? messagesContainerElement : textCompletionAreaElement;
    ...
    <div class="max-w-2xl mx-auto w-full px-3 md:px-0 my-10 h-full">
      <div class=" flex flex-col h-full">
            ...
            <div>
              <button
                class=" flex items-center gap-0.5 text-xs px-2.5 py-0.5 rounded-lg {mode ===
                  'chat' &&
                  'text-sky-600 dark:text-sky-200 bg-sky-200/30'} {mode ===
                  'complete' &&
        ...
        {#if mode === "chat"}
          <div class="p-1">
            <div
              class="p-3 outline outline-1 outline-gray-200 dark:outline-gray-800 rounded-lg"
            >
