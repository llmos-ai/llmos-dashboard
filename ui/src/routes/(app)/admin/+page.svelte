...
<div
  class="min-h-screen max-h-[100dvh] w-full flex justify-center dark:text-white font-mona"
>
  {#if loaded}
      ...
      <div class="max-w-2xl mx-auto w-full px-3 md:px-0 my-10">
        <div class="w-full">
          <div class=" flex flex-col justify-center">
            ...
            <div
              class="scrollbar-hidden relative overflow-x-auto whitespace-nowrap"
            >
              <table
                  ...
                  {#each users as user}
                    ...
                    >
                      <td class="px-3 py-2 min-w-[7rem] w-28">
                        ...
                        >
                          <div
                            class="w-1 h-1 rounded-full {user.role ===
                              'admin' &&
                              'bg-sky-600 dark:bg-sky-300'} {user.role ===
                              'user' &&
