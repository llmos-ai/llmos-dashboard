      ...
      <div class="flex w-full justify-between">
        ...
        <div class="flex items-center relative">
          ...
          >
            ...
            <option value="rose-pine-dawn light"
              >🌷 {$i18n.t("Rosé Pine Dawn")}</option
            >
          </select>
        </div>
      </div>
      ...
      on:click={() => {
        saveSettings({
          ...
          options: {
            ...
            stop:
              options.stop !== ""
                ? options.stop.split(",").filter((e) => e)
                : undefined,
            temperature:
              options.temperature !== "" ? options.temperature : undefined,
            repeat_penalty:
            ...
            mirostat_eta:
              options.mirostat_eta !== "" ? options.mirostat_eta : undefined,
            mirostat_tau:
              options.mirostat_tau !== "" ? options.mirostat_tau : undefined,
            top_k: options.top_k !== "" ? options.top_k : undefined,
            top_p: options.top_p !== "" ? options.top_p : undefined,
            tfs_z: options.tfs_z !== "" ? options.tfs_z : undefined,
            num_ctx: options.num_ctx !== "" ? options.num_ctx : undefined,
            num_predict:
              options.num_predict !== "" ? options.num_predict : undefined,
          },
          keepAlive: keepAlive
            ? isNaN(keepAlive)
              ? keepAlive
