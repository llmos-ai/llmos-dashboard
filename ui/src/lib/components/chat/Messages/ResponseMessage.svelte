    ...
    <div class="w-full overflow-hidden">
      <Name>
        ...
        {#if message.timestamp}
          <span
            class=" invisible group-hover:visible text-gray-400 text-xs font-medium"
          >
            {dayjs(message.timestamp * 1000).format(
              $i18n.t("DD/MM/YYYY HH:mm")
            )}
          </span>
        {/if}
      </Name>
                  ...
                  >
                    {#if siblings.length > 1}
                      <div class="flex self-center min-w-fit -mt-1">
                        ...
                        <div
                          class="text-xs font-bold self-center min-w-fit dark:text-gray-100"
                        >
                    ...
                    <Tooltip content="Good Response" placement="bottom">
                      <button
                        class="{isLastMessage
                          ? 'visible'
                          : 'invisible group-hover:visible'} p-1 rounded {message.rating ===
                        1
